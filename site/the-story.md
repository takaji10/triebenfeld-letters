---
layout: page
title: The story the letters tell
standfirst: Eighteen years, two men, and the slow loss of a fortune. A guide for anyone opening this correspondence for the first time.
permalink: /the-story/
lang: en
alt_url: /de/die-geschichte/
---

This edition holds 318 documents written between 1798 and 1816. Read one on its own and it
is hard going. They open in the middle of business, assume you know everyone, and are full
of sums. Read in order, they turn out to be a single continuous story about a man trying
for eighteen years to save another man's fortune, and failing.
...
Friedrich Ludwig, Fürst zu Hohenlohe-Ingelfingen (1746 to 1818) was a Prussian general
...
[Cabinet Councillor Beyme]({{ '/letters/77/' | relative_url }}), Minister
[Struensee]({{ '/letters/79/' | relative_url }}), Count Hoym, and above all Colonel von
...
[could be counted as good as concluded]({{ '/letters/96/' | relative_url }}). It was not.
...
properties]({{ '/letters/87/' | relative_url }}). The refusal survives here as
[a copy of the royal rescript]({{ '/letters/85/' | relative_url }}), and the Prince was
still [petitioning against it two years later]({{ '/letters/101/' | relative_url }}).

> The honest Cabinet Councillor Beyhm let me read the papers in the Cabinet myself.
> <cite>[Letter 96]({{ '/letters/96/' | relative_url }})</cite>
{: .pull}
...
Hussites, [came to look at the land]({{ '/letters/120/' | relative_url }}) at 300
Reichsthaler a *Hufe*, then [went home to fetch their
co-religionists]({{ '/letters/126/' | relative_url }}). Mennonites from West Prussia
[offered to buy Zagorowo and Trąbczyn entire]({{ '/letters/146/' | relative_url }}) and
...
word itself: ["die Hauländer oder Collonisten"]({{ '/letters/216/' | relative_url }}).
...
year]({{ '/letters/179a/' | relative_url }}), and hereditary rents from the newly parcelled
...
[sold in 1804]({{ '/letters/136/' | relative_url }}). Countess Schlabrendorff
[would not wait past Christmas]({{ '/letters/118b/' | relative_url }}) for 50,000
...
[150,000 Reichsthaler]({{ '/letters/158/' | relative_url }}), 50,000 of it at once against
...
> <cite>[Letter 158]({{ '/letters/158/' | relative_url }})</cite>
{: .pull}
...
> ([Letter 124]({{ '/letters/124/' | relative_url }}))
...
[a letter of relief]({{ '/letters/26/' | relative_url }}) from Breslau at the end of
...
> <cite>[Letter 26]({{ '/letters/26/' | relative_url }})</cite>
{: .pull}
...
Kalisz]({{ '/letters/28/' | relative_url }}) and handed to the heirs of the old owner.
Kaemen went the same way, [seized by force, and nothing to be
done]({{ '/letters/27/' | relative_url }}). It happened, as the Prince's own later petition
puts it, [fourteen weeks after the Peace of
Tilsit]({{ '/letters/265b/' | relative_url }}).
...
[is refused]({{ '/letters/198/' | relative_url }}), petitions the Emperor at Dresden, and
[gets the estates restored to her by the Polish
commissioners]({{ '/letters/217/' | relative_url }}) anyway. Triebenfeld's complaint is
always procedural, that she took possession
["without any decrees or judgments whatever"]({{ '/letters/215/' | relative_url }}), and it
...
[arrested in Berlin by two French gendarmes]({{ '/letters/30/' | relative_url }}) as the
...
it]({{ '/letters/42/' | relative_url }}) is worth reading. In 1809 he
[fled Berlin]({{ '/letters/45/' | relative_url }}) to avoid arrest over another judgment,
[was robbed on the road]({{ '/letters/57/' | relative_url }}) of a trunk worth 800
...
> <cite>[Letter 57]({{ '/letters/57/' | relative_url }})</cite>
{: .pull}
...
[letter 48]({{ '/letters/48/' | relative_url }}) and
[letter 302]({{ '/letters/302/' | relative_url }}), written from Kontop on 7 March 1809. In
...
[running thirty-one lawsuits at once]({{ '/letters/212/' | relative_url }}) and recovering
...
grace]({{ '/letters/215/' | relative_url }}), which was also the practical course, since
...
decrees"]({{ '/letters/216/' | relative_url }}) and the land turned back into demesne farms.
...
He [arrived in October]({{ '/letters/242/' | relative_url }}) after three days on the road,
into a city where the paper money ruined foreigners and everything cost more than he had.
One letter [itemises his own poverty]({{ '/letters/243/' | relative_url }}) line by line:
...
> <cite>[Letter 266]({{ '/letters/266/' | relative_url }})</cite>
{: .pull}

The lobbying was real, and for a while it looked hopeful. He petitioned
[Prince State Chancellor Hardenberg]({{ '/letters/245/' | relative_url }}) and
[received a reply]({{ '/letters/252/' | relative_url }}). Wilhelm von Humboldt
[took up the case]({{ '/letters/250/' | relative_url }}) and demanded copies of everything.
Hardenberg was reported saying that Hohenlohe was
[the worst-treated of men]({{ '/letters/262/' | relative_url }}). Triebenfeld tracked the
...
[under Russian sovereignty]({{ '/letters/266/' | relative_url }}), out of reach of any
Prussian court. In February 1815 he reported the line
[settled, and against him]({{ '/letters/271/' | relative_url }}).

Then Napoleon left Elba. Triebenfeld's letters
[fill with Grenoble and Lyon]({{ '/letters/4/' | relative_url }}), with the ten million
francs on Bonaparte's head, and then with the news that he
[stands almost at the Rhine with 200,000 men]({{ '/letters/286/' | relative_url }}). The
...
[answers three of them point by point]({{ '/letters/273/' | relative_url }}), defending his
...
> <cite>[Letter 273]({{ '/letters/273/' | relative_url }})</cite>
{: .pull}
...
> ([Letter 7]({{ '/letters/7/' | relative_url }}))
...
[that he is still alive and where he is]({{ '/letters/297/' | relative_url }}).
...
[an extract from the liquidation protocols]({{ '/letters/303/' | relative_url }}), listing
...
For the story in a dozen documents, read them in this order:

1. [Letter 77]({{ '/letters/77/' | relative_url }}), the exchange scheme in full flow
2. [Letter 85]({{ '/letters/85/' | relative_url }}), the King says no
3. [Letter 124]({{ '/letters/124/' | relative_url }}), his wife's burial, and the business of the day
4. [Letter 179a]({{ '/letters/179a/' | relative_url }}), what the estates were actually worth
5. [Letter 26]({{ '/letters/26/' | relative_url }}), relief that the Prince survived 1806
6. [Letter 28]({{ '/letters/28/' | relative_url }}), the estates taken away
7. [Letter 48]({{ '/letters/48/' | relative_url }}), the counter-attack and its thirteen powers of attorney
8. [Letter 212]({{ '/letters/212/' | relative_url }}), thirty-one lawsuits, written from a peasant's hut
9. [Letter 243]({{ '/letters/243/' | relative_url }}), the cost of a day in Vienna
10. [Letter 266]({{ '/letters/266/' | relative_url }}), a river decides everything
11. [Letter 7]({{ '/letters/7/' | relative_url }}), Charlotte writes
12. [Letter 297]({{ '/letters/297/' | relative_url }}), the deaths

Every document has a German transcription, a reading text, and, for 313 of them, an English
translation, alongside the manuscript images. Start
[browsing]({{ '/letters/' | relative_url }}), or read
