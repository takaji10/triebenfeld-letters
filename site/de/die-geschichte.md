---
layout: page
title: Die Geschichte, die die Briefe erzählen
standfirst: Achtzehn Jahre, zwei Männer und der langsame Verlust eines Vermögens. Eine Einführung für alle, die diese Korrespondenz zum ersten Mal aufschlagen.
...
geschlossene preußische Domänen tauschen, Krotoszyn und Polajewo, und so seine Schulden
...
erreichen konnte: [Cabinetsrath Beyme]({{ '/documents/oe1bu9454/77/' | relative_url }}), Minister
[Struensee]({{ '/documents/oe1bu9454/79/' | relative_url }}), Graf Hoym und vor allem Obrist von
...
[so gut wie abgeschlossen anzusehen]({{ '/documents/oe1bu9454/96/' | relative_url }}). Sie war es
...
[nie an Ort und Stelle besichtigt hatte]({{ '/documents/oe1bu9454/87/' | relative_url }}). Die
Ablehnung liegt hier als [Abschrift des königlichen
Rescripts]({{ '/documents/oe1bu9454/85/' | relative_url }}) vor, und der Fürst
[bat noch zwei Jahre später dagegen an]({{ '/documents/oe1bu9454/101/' | relative_url }}).

> Der redliche Lab: Rath Beyhm hatt mich die Sachen in Cab: selbst lesen laßen.
> <cite>[Brief 96]({{ '/documents/oe1bu9454/96/' | relative_url }})</cite>
{: .pull}
...
die Hufe und [holten darauf ihre Glaubensbrüder]({{ '/documents/oe1bu9454/126/' | relative_url }}).
Mennoniten aus Westpreußen [boten an, Zagorowo und Trąbczyn im
ganzen zu kaufen]({{ '/documents/oe1bu9454/146/' | relative_url }}) und unter sich aufzuteilen. Daneben
...
jährlich]({{ '/documents/oe1bu9454/179a/' | relative_url }}) an, und die Erbzinsen der neu
...
[1804 verkauft]({{ '/documents/oe1bu9454/136/' | relative_url }}). Die Gräfin Schlabrendorff
[wollte über Weihnachten hinaus nicht warten]({{ '/documents/oe1bu9454/118b/' | relative_url }}) auf
...
[150.000 Reichsthaler]({{ '/documents/oe1bu9454/158/' | relative_url }}) zu, davon 50.000 sogleich
...
> ([Brief 124]({{ '/documents/oe1bu9454/124/' | relative_url }}))
...
Erleichterung]({{ '/documents/oe1bu9454/26/' | relative_url }}) aus Breslau von Ende Oktober 1806, in
...
> <cite>[Brief 26]({{ '/documents/oe1bu9454/26/' | relative_url }})</cite>
{: .pull}
...
übernommen]({{ '/documents/oe1bu9454/28/' | relative_url }}) und den Erben des alten Besitzers
übergeben. Kaemen ging denselben Weg,
[gewaltsam genommen, und nichts dagegen zu
machen]({{ '/documents/oe1bu9454/27/' | relative_url }}). Es geschah, wie die spätere Bittschrift des
Fürsten selbst sagt, [vierzehn Wochen nach dem Tilsiter
Frieden]({{ '/documents/oe1bu9454/265b/' | relative_url }}).
...
[wird abgewiesen]({{ '/documents/oe1bu9454/198/' | relative_url }}), bittet den Kaiser in Dresden an
und [erhält die Güter von den polnischen Commissarien gleichwohl
zurück]({{ '/documents/oe1bu9454/217/' | relative_url }}). Triebenfelds Einwand ist immer der
...
verhaftet]({{ '/documents/oe1bu9454/30/' | relative_url }}), als Generalbevollmächtigter des Fürsten,
...
darüber]({{ '/documents/oe1bu9454/42/' | relative_url }}) lohnt die Lektüre. 1809
[floh er aus Berlin]({{ '/documents/oe1bu9454/45/' | relative_url }}), um der Personalhaft aus einem
anderen Erkenntnis zu entgehen, [wurde unterwegs
beraubt]({{ '/documents/oe1bu9454/57/' | relative_url }}) um einen Koffer im Wert von 800
...
[Brief 48]({{ '/documents/oe1bu9454/48/' | relative_url }}) und
[Brief 302]({{ '/documents/oe1bu9454/302/' | relative_url }}), aus Kontop vom 7. März 1809. In einer
...
[einunddreißig Prozesse zugleich]({{ '/documents/oe1bu9454/212/' | relative_url }}) und brachte fast
...
erlassen]({{ '/documents/oe1bu9454/215/' | relative_url }}), was zugleich das Praktische war, denn
...
Er [traf im Oktober ein]({{ '/documents/oe1bu9454/242/' | relative_url }}), nach drei Tagen Reise, in
...
auf]({{ '/documents/oe1bu9454/243/' | relative_url }}): die Stube, den Kaffee, das eine Glas Wein, das
...
> <cite>[Brief 266]({{ '/documents/oe1bu9454/266/' | relative_url }})</cite>
{: .pull}

Das Werben war ernsthaft und sah eine Zeitlang hoffnungsvoll aus. Er reichte beim
[Staatskanzler Fürsten Hardenberg]({{ '/documents/oe1bu9454/245/' | relative_url }}) ein und
[erhielt Bescheid]({{ '/documents/oe1bu9454/252/' | relative_url }}). Wilhelm von Humboldt
[nahm sich der Sache an]({{ '/documents/oe1bu9454/250/' | relative_url }}) und verlangte Abschriften
von allem. Von Hardenberg wird das Wort berichtet, Hohenlohe sei
[„dieser redliche Mann ... der am meisten gelitten
hat“]({{ '/documents/oe1bu9454/262/' | relative_url }}). Triebenfeld verfolgte den ganzen Kongress, die
...
[unter russische Landeshoheit]({{ '/documents/oe1bu9454/266/' | relative_url }}), außer Reichweite
jedes preußischen Gerichts. Im Februar 1815 meldete er die Linie
[als festgesetzt, und gegen ihn]({{ '/documents/oe1bu9454/271/' | relative_url }}).

Dann verließ Napoleon Elba. Triebenfelds Briefe
[füllen sich mit Grenoble und Lyon]({{ '/documents/oe1bu9454/4/' | relative_url }}), mit den zehn
...
> <cite>[Brief 273]({{ '/documents/oe1bu9454/273/' | relative_url }})</cite>
{: .pull}

Im März 1815 schreibt seine Tochter Charlotte dem Fürsten unmittelbar, aus Breslau. Es ist
ihr dritter Brief, und keiner ist beantwortet worden. Sie schreibt, weil sie nicht weiß, wo
ihr Vater ist, und ihn nur über den Mann erreichen kann, in dessen Diensten er steht:
...
ist]({{ '/documents/oe1bu9454/297/' | relative_url }}).
...
[ein Auszug aus den Liquidationsprotokollen]({{ '/documents/oe1bu9454/303/' | relative_url }}), der 142
...
Summe wie der Vorschuss, der die ganze Korrespondenz als finanzieller Hauptfaden
durchzieht. Ob es dieselben 112.000 sind und ob jene Charlotte die Tochter ist, die Brief 7
geschrieben hat, sagen die Dokumente nicht. Es steht hier als offene Frage.

## Die Personen, denen Sie immer wieder begegnen

Auf der Seite des Fürsten ist Hahn der Hofrath, der für den Fürsten schreibt, wenn dieser
nicht selbst schreiben will. Glenck, Bau-Rath und Vermesser, beginnt als Mitarbeiter und
wird nach Triebenfelds Darstellung zum Hindernis. Amelang ist der Berliner Agent. Honrichs
und Hawich sind zwei verschiedene Männer, leicht zu verwechseln, beide Gutsbeamte, und
jeder vom anderen des Betrugs bezichtigt.

Bei Hofe ist Köckritz der Generaladjutant des Königs und der Grund, weshalb das Darlehen
der Invalidenkasse überhaupt zustande kam. Beyme ist Cabinetsrath, Voss der Minister, der
den Tausch zu Fall brachte. Später kommen Hardenberg, Humboldt und Stägemann hinzu.

Auf der Gegenseite steht Cosmar, der Jurist, dessen Transact von 1811 mit den Gläubigern
des Fürsten Triebenfeld von Anfang bis Ende für betrügerisch hält und dessen Beseitigung in
den Wiener Jahren zur festen Idee wird. Weigel und Stössel sind Gläubiger, groß genug, um
mit ihnen zu verhandeln, statt sie zu bezahlen. Oppenheimer, von der Lahr und Schlabrendorff
sind Namen, bei denen ein Gerichtsbeschluss bevorsteht. Und da ist die Tochter Prussiemskis,
unter welchem Namen auch immer.

Die Seite [Personen]({{ '/de/personen/' | relative_url }}) verzeichnet alle durch die
Korrespondenz verfolgbaren Personen, mit den Belegen für jede Identifizierung und dem Grad
ihrer Sicherheit.
...
ihnen. Sie stammen überwiegend aus Triebenfelds eigener Sachwaltung, und Ziffern sind die
schwächste Stelle der Transkription. Wo eine Summe zählt, prüfen Sie sie an der Handschrift.
